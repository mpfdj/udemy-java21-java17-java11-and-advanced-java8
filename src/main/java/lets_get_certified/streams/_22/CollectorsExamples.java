package lets_get_certified.streams._22;
...
//        doGroupingBy3();
    ...
    public static void doCollectToMap1() {
        ...
        Stream<String> persons = Stream.of("Miel", "Efril", "Kim", "Isabella");

        Map<Integer, String> personsMap = persons.collect(Collectors.toMap(p -> p.length(),
                p -> p)
        );
