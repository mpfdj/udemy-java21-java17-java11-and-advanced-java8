package lets_get_certified.streams._27;
...
//                                                         n -> n+2);   // next number 
    ...
    public static void creatingPrimitiveStreams(){
        ...
        int sum = numbers.reduce(0, (n1, n2) -> n1 + n2);
        System.out.println("Using reduce. Sum: " + sum);


        Supplier<IntStream> numbersSupplier = () -> IntStream.of(1,2,3);  // Use Primitive stream
//        Supplier<IntStream> numbersSupplier = () -> Stream.of(1,2,3).mapToInt(n -> n); // Map Integer to int

        int sum2 = numbersSupplier.get().sum();
        System.out.println("Using primitive stream. Sum: " + sum2);

        OptionalDouble average2 = numbersSupplier.get().average();
        average2.ifPresent((avg) -> System.out.println("Using primitive stream. Average: " + avg));
