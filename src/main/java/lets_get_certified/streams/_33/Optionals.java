package lets_get_certified.streams._33;
...
//        testWithIfPresent();
    ...
    public static void testWithIfPresent() {
        Optional<String> optionalString;
        String s;

        optionalString= Optional.of("Hello");
        s = getStringIfObjectIsPresent(optionalString);
        System.out.println("getStringIfObjectIsPresent: " + s);


        if (optionalString.isPresent()) {
            s= optionalString.get();
            System.out.println("getStringIfObjectIsPresent2: " + s);
        }

        s = optionalString.orElse("No string found.");
        System.out.println("getStringIfObjectIsPresent3: " + s);
    ...
    public static String getStringIfObjectIsPresent(Optional<String> optional) {
